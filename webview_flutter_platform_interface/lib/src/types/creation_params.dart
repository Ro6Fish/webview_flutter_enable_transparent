...
class CreationParams {
  ...
  @override
  String toString() {
    return '$runtimeType(initialUrl: $initialUrl, settings: $webSettings, javascriptChannelNames: $javascriptChannelNames, UserAgent: $userAgent, transparentBackground: $transparentBackground)';
  }
}
